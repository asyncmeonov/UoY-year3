...
\begin{outline}
  \1 neuron activation functions are differentiable, unlike the hard limits we had before
  \1 between our input and output nodes we construct one or more \textit{hidden layers} containing one or more neurons
